...
if t<t0
G1=[3.5+0*b*cos(t1) -1+0*b*sin(t1)]';
V1=norm(p1-G1)^2;

G2=[3.5+0*b*cos(t2) -0.8+0*b*sin(t2)]';
V2=norm(p2-G2)^2;

else
 G1=[-5+0*b*cos(t1) 7.5+0*b*sin(t1)]';
V1=norm(p1-G1)^2;

G2=[5+0*b*cos(t2) -1+0*b*sin(t2)]';
V2=norm(p2-G2)^2;   
    
end

G3=[-3+0*b*cos(t3) 11+0*b*sin(t3)]';
V3=norm(p3-G3)^2;
